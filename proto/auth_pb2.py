...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_REFRESHTOKENREQUEST']._serialized_start=154
  _globals['_REFRESHTOKENREQUEST']._serialized_end=198
  _globals['_REFRESHTOKENRESPONSE']._serialized_start=200
